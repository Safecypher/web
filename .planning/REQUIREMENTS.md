...
- [x] **ANLT-02**: PostHog installed on public site and portal; tracks page views, CTA clicks, form starts, funnel events
...
- Phase 8 gap closure: 2 requirements reset to Pending (SV-09, PORT-04)
